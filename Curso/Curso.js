...
{     
	...
	$(".caja_c .curso_formulario").submit(function(){
	...
	$(".eliminar_curso").click(function(){
		var confirmar = confirm("Desea eliminar este curso");
		if(confirmar)
		{
			var id = $(this).attr("value"); 
			$.post("../Scripts/guardar.php", {opcion: "eliminar_curso", id: id}, function(data){
				if(data == "")
					$("." + id +"_li").hide();
				else
					alert(data);
