		...
		<div id="contenido" class="columna_derecha_has"><!--has-right-col-->
			<div class="envoltura_literatura" id="envoltura_literatura_publicaciones"><!--literature-wrapper-->
				<div id="envoltura_literatura_div">
					<div class="cabecera_literatura elemento_lleno_ancho" id="elemento_cabecera_literatura" style="height: 127px;"><!--literature-header full-width-element-->
						...
						?>
								<div class="cabecera_contenedora_derecha rf"><!--header-content-right rf-->
									<div class="agregarpublicaciones_perfil contenedor_js"><!--profile-addpublications js-widgetcontainer-->
										<a class="agregar_js boton boton_promover boton_largo boton_ancho_completo">Agregar</a><!--js-add btn btn-promote btn-large btn-fullwidth-->
									</div>
									<div class="limpiar"></div><!--clear-->
								</div>
						<?php
				...
				<div class="contenido_columna_c temporal"><!--c-col-content-->
					<div class="contenido_c" style="padding-top: 0;"><!--c-content-->
						<div class="limpiar"></div><!--clear-->
