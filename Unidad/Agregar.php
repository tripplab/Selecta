<html>
	...
	<body>
		<div class="contenedor_dialogo_publicacion mostrar_cabecera departamento_formulario"><!--publication-dialog-container show-header-->
			<div class="contenedor_dialogo agregar_contenido_diaglogo_js"><!--dialog-content js-add-pub-dialog-content--->
				<div class="arreglar_limpiar contenedor_js"><!--clearfix js-widgetcontainer-->
					<form class="form_horizontal form_accion_submit form_departamento"><!--form-horizontal action-form-submit--->
						<input type="hidden" value="departamento_nuevo" name="opcion">
						<input type="hidden" name="unidad" id="id_unidad">
			...
			<div class="contenedor_dialogo agregar_contenido_diaglogo_js"><!--dialog-content js-add-pub-dialog-content--->
				<div class="arreglar_limpiar contenedor_js"><!--clearfix js-widgetcontainer-->
					<form class="form_horizontal form_accion_submit form_laboratorio"><!--form-horizontal action-form-submit--->
						<input type="hidden" value="laboratorio_u_d_nuevo" name="opcion">
						<input type="hidden" value="" name="unidad" id="id_unidad">
						<div class="contenedor_js"><!--js-widgetcontainer-->
